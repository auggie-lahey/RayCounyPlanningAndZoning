...
#### 1. New Development
The off-street parking and loading standards of this Article apply to any new [building](./Article_150_Definitions.md#building) constructed and to any new [use](./Article_150_Definitions.md#use) established.
...
|---|---|---|
| **Residential** | | |
| Household Living | Multi-[Dwelling](./Article_150_Definitions.md#dwelling) [Structures](./Article_150_Definitions.md#structure) | - 1.5 per efficiency [dwelling unit](./Article_150_Definitions.md#dwelling-unit)<br>- 2.0 per 1-bedroom unit<br>- 2.5 per 2-bedroom or larger unit |
| | All Other Household Living | 2 per [dwelling unit](./Article_150_Definitions.md#dwelling-unit) |
| **Institutional** | | |
| | College | Schedule C |
...
### A. 
Only one principal [structure](./Article_150_Definitions.md#structure) (residence) may be constructed on agriculturally or Residentially zoned property. [Accessory](./Article_150_Definitions.md#accessory-building-or-use) [buildings](./Article_150_Definitions.md#building) and [uses](./Article_150_Definitions.md#use) must comply with the corresponding [zoning district](./Article_150_Definitions.md#zoning-district).

### B. 
A [lot](./Article_150_Definitions.md#lot) may be used for more than 1 principal nonresidential [use](./Article_150_Definitions.md#use) and more than 1 principal nonresidential [structure](./Article_150_Definitions.md#structure), provided that all [structures](./Article_150_Definitions.md#structure) are separated by a minimum distance of 15 feet and provided that development on the [lot](./Article_150_Definitions.md#lot) complies with the proper [zoning district](./Article_150_Definitions.md#zoning-district) and all applicable standards of these Zoning Regulations.

## 100.3 Traffic Impact Studies

### A. Applicability
A traffic impact study may be required with [Zoning District](./Article_150_Definitions.md#zoning-district) Map amendment applications, preliminary [plats](./Article_150_Definitions.md#plat) or [planned unit developments](./Article_150_Definitions.md#planned-unit-development-pud) that are projected to generate 100 or more peak hour vehicle trips or when the [County Commission](./Article_150_Definitions.md#county-commission) determines that the proposed development will have a measurable impact on the county road system.

### B. Study Scope
When a traffic impact study is required, the type and scope of the study shall be determined during a meeting with the [County Commission](./Article_150_Definitions.md#county-commission). The [County Commission](./Article_150_Definitions.md#county-commission) may also involve representatives of or request assessments from other agencies and departments. The elements to be determined during the meeting shall include:
...
Nothing shall be erected, placed, planted, or allowed to grow in such a manner as to impede or obstruct vision between a height of 2 feet and 10 feet (measured from the edge of the road driving surface nearest the obstruction) within an imaginary triangular area formed by points on each [street](./Article_150_Definitions.md#street) center line located:

### A. 
90 feet from the intersection of local [street](./Article_150_Definitions.md#street) center lines and a third (diagonal) line connecting the two points; or

### B. 
120 feet from the intersection of [collector](./Article_150_Definitions.md#collector-street) or [arterial](./Article_150_Definitions.md#arterial-street) [street](./Article_150_Definitions.md#street) center lines and a third (diagonal) line connecting the two points.

## 100.5 Historic Preservation

Whenever there is an existing [structure](./Article_150_Definitions.md#structure) with potential historic value or a site with likelihood to yield a significant archaeological remains, consideration shall be given to preserving the [structure](./Article_150_Definitions.md#structure) or protecting the site prior to any construction or reuse of the property.

### A. Site Evaluation Criteria
Prior to approval of the Final [Plat](./Article_150_Definitions.md#plat), sites should be evaluated to determine if one of the following are present on the site:

1. [Structures](./Article_150_Definitions.md#structure) over 50 years of age;
2. Exceptional works of well-known architects or builders (even if the [structure](./Article_150_Definitions.md#structure) is less than 50 years old);
3. [Structures](./Article_150_Definitions.md#structure) or features listed on the Ray County, State, or National Historic Registers; or
4. [Structures](./Article_150_Definitions.md#structure) that are significant in terms of American history, architecture, culture, archaeology or engineering.

### B. Discovery
If, during any construction, any archeologically or historically significant [structure](./Article_150_Definitions.md#structure) or features are discovered, the property owner shall notify the Ray County Historical Society and the state historic preservation officer of the discovery. Upon discovery of archeologically or historically significant [structures](./Article_150_Definitions.md#structure), all construction activity shall cease until significant items have been salvaged.

## 100.6 Residential Design Standards

All detached houses shall be subject to the residential design standards of this Article, provided that houses located within [mobile home](./Article_150_Definitions.md#mobile-home) parks shall not be subject to these standards. The County's currently adopted [building](./Article_150_Definitions.md#building) codes shall govern all [building](./Article_150_Definitions.md#building) requirements.
...
#### 2. Living Area
Each detached house shall comply with the minimum living area standard of the underlying [zoning district](./Article_150_Definitions.md#zoning-district).
...
#### 1. Siting
[Manufactured housing](./Article_150_Definitions.md#manufactured-home) units shall be installed in accordance with the recommended installation procedures of the manufacturer and the standards set by the International Conference of [Building](./Article_150_Definitions.md#building) Officials (ICBO) and published in the most recent edition of "Guidelines for [Manufactured Housing](./Article_150_Definitions.md#manufactured-home) Installations." A continuous, permanent concrete or masonry foundation or masonry curtain wall, unpierced except for required ventilation and access which may include walkout basements and garages, shall be installed under the perimeter of the home, in accordance with the above-referenced ICBO "Guidelines." All running gear, tongues, axles, and wheels must be removed at the time of installation of the house on the [lot](./Article_150_Definitions.md#lot).

#### 2. Placement
Detached houses shall be placed so that the apparent entrance or "front" of the [structure](./Article_150_Definitions.md#structure) faces or parallels the primary [street](./Article_150_Definitions.md#street) [frontage](./Article_150_Definitions.md#frontage), except where the [lot](./Article_150_Definitions.md#lot) is 3 or more acres in size and the unit is set back at least 150 feet from all property lines.
...
The finished [floor area](./Article_150_Definitions.md#floor-area) elevation of the first floor of the detached house shall be a maximum of 24 inches above the exterior finish grade of the [lot](./Article_150_Definitions.md#lot) on which it is located, as measured at the main entrance of the [dwelling](./Article_150_Definitions.md#dwelling).

### G. Attached Additions
Any attached addition shall comply with county building codes.

### H. Garages
Detached garages may be constructed on the same [lot](./Article_150_Definitions.md#lot) as a detached house, provided that such [structures](./Article_150_Definitions.md#structure) comply with all applicable [building](./Article_150_Definitions.md#building) code requirements.